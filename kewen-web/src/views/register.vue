<template>
    <div>
        <el-form ref="registerForm" :rules="rules" :model="registerForm" class="loginContainer" >
            ...
            <a href="./Login.vue" id="loginLink">立即登录</a>
            <el-form-item>
               
                <el-button type="primary" class="login-btn" @click="submitRigister">注册</el-button>
            </el-form-item>
        </el-form>
    </div>
</template>
